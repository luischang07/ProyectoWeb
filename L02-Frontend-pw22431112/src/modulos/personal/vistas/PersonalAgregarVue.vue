...
let personal = ref<PersonalAgregar>({
    ...
    direccion: '',
    telefono: '',
    estatus: '0'  // Mantener como string
});
...
<template>
    <div class="container-fluid d-flex justify-content-center align-items-center min-vh-100">
        <div class="card w-100 col-lg-8 col-md-10 col-sm-12 shadow-lg bg-light small-card">
            ...
            <div class="alert alert-success text-center mt-3" v-if="mensaje && mensaje[0] === 'Personal agregado con éxito'" role="alert">
                {{ mensaje[0].toString() }}
            </div>
            <div class="alert alert-danger text-center mt-3" v-for="(error, index) in mensaje" :key="index" v-if="mensaje && mensaje[0] !== 'Personal agregado con éxito'" role="alert">
                {{ error }}
            </div>
            <div class="card-body">
                <Form :validation-schema="personalSchema" @submit="onValidated">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <Field type="radio" class="form-check-input" name="estatus" value="1" v-model="personal.estatus" />
                            <label class="form-check-label" for="estatusActivo">Activo</label>
                        </div>
                        <div class="form-check">
                            <Field type="radio" class="form-check-input" name="estatus" value="0" v-model="personal.estatus" />
