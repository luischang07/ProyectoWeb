...
import { eliminarPersonal, insertarPersonal, modificarPersonal, obtenerPersonal, obtenerPersonalSinPaginar, obtenerPorTelefono, obtenerUnPersonal } from '../controller/personalController'
